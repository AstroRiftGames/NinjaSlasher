...
public class LevelUnlockRequirements
{
    ...
    [Tooltip("Solo nivel 1 deber�a tener esto en true")]
    ...
    [Tooltip("ID del �rea al que pertenece este nivel (1-5)")]
    public int areaId = 1;
}
...
public class LevelConfiguration : ScriptableObject
{
    ...
    [Tooltip("Caracter�sticas espec�ficas del nivel para evaluaci�n de objetivos")]
